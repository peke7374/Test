...
function ChangeTheme(ThemeName)
	...
	ArrayField.Main.Topbar.Position = UDim2.new(ArrayField.Main.Topbar.Position.X.Scale, ArrayField.Main.Topbar.Position.X.Offset, ArrayField.Main.Topbar.Position.Y.Scale, ArrayField.Main.Topbar.Position.Y.Offset + 40)
